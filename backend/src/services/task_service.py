...
class TaskService:
    ...
    async def update_task(
        self, session: AsyncSession, task_id: int, task_data: TaskCreate, user_id: str
    ) -> TaskRead:
        ...
        updated_task = await self.repository.update(session, task_id, task_to_update, user_id)
